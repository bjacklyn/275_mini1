...
//BENCHMARK_REGISTER_F(CollisionManagerBenchmark, SearchSingleStringIndex)->Iterations(NUM_ITERATIONS);
//BENCHMARK_REGISTER_F(CollisionManagerBenchmark, SearchSingleStringParallel)->Iterations(NUM_ITERATIONS);
BENCHMARK_REGISTER_F(CollisionManagerBenchmark, boroughmatches)->Iterations(NUM_ITERATIONS);
